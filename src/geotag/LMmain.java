...
public class LMmain {
	...
	public LMmain(int N, int T, int K, int m, int u, String trainFile, 
			String testFile, String action, String dir) throws IOException, ClassNotFoundException {


		System.out.println("Method : Language Model");
		...
		for (int i=0;i<testSet.length;i++){
			...
			if (!testSet[i].equals("")){
				...
				if (maxAreaId!=null){
					estCoord = mendoids.get(maxAreaId);
				} 
				else {
		...
		FileWriter fstream = new FileWriter("results/LanguageModel/clust_" + K +"_2");
